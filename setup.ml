...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7708b15cc5367e57d42cf9313cfa29e6) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          description =
            Some
              [
                 OASISText.Para
                   "A prototype language focused on organizing concurrent programs via communication along substructurally channels between processes."
              ];
          categories = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "~\025(≈y\128Î_UœƒÓÏE\027\005";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
